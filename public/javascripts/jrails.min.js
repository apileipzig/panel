...
(function(c){c.extend({fieldEvent:function(a,b){var d=a[0]||a,g="change";if(d.type=="radio"||d.type=="checkbox")g="click";else if(b&&(d.type=="text"||d.type=="textarea"||d.type=="password"))g="keyup";return g}});c.fn.extend({delayedObserver:function(a,b){var d=c(this);if(typeof window.delayedObserverStack=="undefined")window.delayedObserverStack=[];if(typeof window.delayedObserverCallback=="undefined")window.delayedObserverCallback=function(h){var f=window.delayedObserverStack[h];f.timer&&clearTimeout(f.timer);
f.timer=setTimeout(function(){f.timer=null;f.callback(f.obj,f.obj.formVal())},f.delay*1E3);f.oldVal=f.obj.formVal()};window.delayedObserverStack.push({obj:d,timer:null,delay:a,oldVal:d.formVal(),callback:b});var g=window.delayedObserverStack.length-1;d[0].tagName=="FORM"?c(":input",d).each(function(){var h=c(this);h.bind(c.fieldEvent(h,a),function(){var f=window.delayedObserverStack[g];f.obj.formVal()!=f.oldVal&&window.delayedObserverCallback(g)})}):d.bind(c.fieldEvent(d,a),function(){var h=window.delayedObserverStack[g];
h.obj.formVal()!=h.oldVal&&window.delayedObserverCallback(g)})},formVal:function(){var a=this[0];if(a.tagName=="FORM")return this.serialize();return a.type=="checkbox"||a.type=="radio"?this.filter("input:checked").val()||"":this.val()}})})(jQuery);
(function(c){c.fn.extend({visualEffect:function(a,b){speed=b?b.duration*1E3:null;e=a.replace(/\_(.)/g,function(d,g){return g.toUpperCase()});return eval("$(this)."+e+"("+speed+")")},appear:function(a,b){return this.fadeIn(a,b)},blindDown:function(a,b){return this.show("blind",{direction:"vertical"},a,b)},blindUp:function(a,b){return this.hide("blind",{direction:"vertical"},a,b)},blindRight:function(a,b){return this.show("blind",{direction:"horizontal"},a,b)},blindLeft:function(a,b){this.hide("blind",
